"""PKCS#11 CKR spec DATA TABLES (extracted from _ckr_spec.py; Tier-4 god-module split).

The per-family ``dict[str, CkrExpectation]`` spec tables. The assertion LOGIC
(assert_ckr / CkrExpectation / full_compat) stays in _ckr_spec.py, which re-exports
these so the public import surface is unchanged.
"""
...
CKR_VERIFY: dict[str, CkrExpectation] = {
    ...
    "init_key_function_not_permitted": CkrExpectation(
        ...
        spec_ref="PKCS#11 v3.2",
        allow_success=True,  # some modules do not check CKA_VERIFY at init
    ),
    # --- C_Verify errors ---
...
CKR_KEYGEN: dict[str, CkrExpectation] = {
    ...
    "genkey_bad_size": CkrExpectation(
        ...
        # some modules have no symmetric-keygen surface -> CKR_FUNCTION_NOT_SUPPORTED for any
        ...
        spec_ref="PKCS#11 v3.2",
        allow_success=True,  # some modules accept AES key size 0 and non-standard sizes
    ),
    ...
    "genkey_template_inconsistent": CkrExpectation(
        ...
        # PC-6: some modules have no symmetric-keygen surface -> FUNCTION_NOT_SUPPORTED (xfail).
...
CKR_DERIVE: dict[str, CkrExpectation] = {
    ...
    "key_type_inconsistent": CkrExpectation(
        ...
        spec_ref="PKCS#11 v3.2",
        # some modules return CKR_TEMPLATE_INCOMPLETE or CKR_MECHANISM_PARAM_INVALID,
        # others return CKR_KEY_HANDLE_INVALID
    ),
...
CKR_KEM: dict[str, CkrExpectation] = {
    ...
    "encap_key_type_inconsistent": CkrExpectation(
        ...
        compat_tuple=(
            ...
            CKR_TEMPLATE_INCONSISTENT,
            CKR_FUNCTION_FAILED,
            # on some modules RSA keys are not visible in the PQC-slot context so the
...
CKR_WRAP: dict[str, CkrExpectation] = {
    ...
    "wrap_wrapping_key_size_range": CkrExpectation(
        ...
        # by full_compat(), so a catch-all reject (e.g. a module returning
...
CKR_OBJECT: dict[str, CkrExpectation] = {
    ...
    "set_attr_readonly": CkrExpectation(
        ...
        spec_ref="PKCS#11 v3.2",
        allow_success=True,  # some modules accept CKA_CLASS modification
    ),
...
CKR_WRAP_AUTH: dict[str, CkrExpectation] = {
    ...
    "unwrap_auth_arguments_bad": CkrExpectation(
        ...
        compat_tuple=(CKR_ARGUMENTS_BAD, CKR_FUNCTION_FAILED),
        spec_ref="PKCS#11 v3.2",
        testable=True,  # Testable on v3.2+ modules via funclist32_ptr
    ),
