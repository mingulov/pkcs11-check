...
def _tf_key(raw: Any, sh: int, bits: int, attrs: Mapping[Any, Any]) -> int:
        ...
        try:
            ...
            if ct == _TWO_BLOCKS:
                classify(
                    "wrong_result",
                    kind="crypto",
                    label="CKM_TWOFISH_CBC:encrypt confidentiality",
                    operation="C_Encrypt",
            ...
            assert_correct(
                ...
                label="CKM_TWOFISH_CBC:decrypt roundtrip",
                operation="C_Decrypt",
                mechanism="CKM_TWOFISH_CBC",
            )
        finally:
        ...
        try:
            ...
            if ct1 == ct2:
                classify(
                    "wrong_result",
                    kind="crypto",
                    label="CKM_TWOFISH_CBC:encrypt IV independence",
                    operation="C_Encrypt",
                    mechanism="CKM_TWOFISH_CBC",
        ...
        try:
            ...
            if ct == plaintext:
                classify(
                    "wrong_result",
                    kind="crypto",
                    label="CKM_TWOFISH_CBC_PAD:encrypt confidentiality",
                    operation="C_Encrypt",
                    mechanism="CKM_TWOFISH_CBC_PAD",
                    summary="ciphertext equals plaintext -- encryption was a no-op",
                )
            ...
            assert_correct(
                actual=pt,
                expected=plaintext,
                label="CKM_TWOFISH_CBC_PAD:decrypt roundtrip",
                operation="C_Decrypt",
                mechanism="CKM_TWOFISH_CBC_PAD",
            )
        finally:
        ...
        try:
            ...
            if ct1 == ct2:
                classify(
                    "wrong_result",
                    kind="crypto",
                    label="CKM_TWOFISH_CBC_PAD:encrypt key independence",
                    operation="C_Encrypt",
                    mechanism="CKM_TWOFISH_CBC_PAD",
