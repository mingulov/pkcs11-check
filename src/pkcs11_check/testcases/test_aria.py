...
def _encrypt_or_xfail(
    ...
    *,
    ...
    try:
        ...
        xfail_if_known_ckr(
            exc, CIPHER_OP_RUNTIME_REJECT_RVS, "ARIA mechanism advertised but not operational"
        )
        raise
...
class TestARIAKeyGen:
    ...
    def test_aria_key_gen(self, p11_raw_session: Any, key_bits: int) -> None:
...
class TestARIAEncryption:
    ...
    def test_aria_ecb_roundtrip(self, p11_raw_session: Any) -> None:
        ...
        try:
            ...
            if ct == _TWO_BLOCKS:
                classify(
                    "wrong_result",
                    kind="crypto",
                    label="CKM_ARIA_ECB:encrypt confidentiality",
                    operation="C_Encrypt",
            ...
            assert_correct(
                ...
                label="CKM_ARIA_ECB:decrypt roundtrip",
                operation="C_Decrypt",
                mechanism="CKM_ARIA_ECB",
            )
        finally:
    ...
    def test_aria_ecb_different_keys(self, p11_raw_session: Any) -> None:
        ...
        try:
            ...
            if ct1 == ct2:
                classify(
                    "wrong_result",
                    kind="crypto",
                    label="CKM_ARIA_ECB:encrypt key independence",
                    operation="C_Encrypt",
                    mechanism="CKM_ARIA_ECB",
    ...
    def test_aria_cbc_roundtrip(self, p11_raw_session: Any) -> None:
        ...
        try:
            ...
            if ct == _TWO_BLOCKS:
                classify(
                    "wrong_result",
                    kind="crypto",
                    label="CKM_ARIA_CBC:encrypt confidentiality",
                    operation="C_Encrypt",
            ...
            assert_correct(
                actual=pt,
                expected=_TWO_BLOCKS,
                label="CKM_ARIA_CBC:decrypt roundtrip",
                operation="C_Decrypt",
                mechanism="CKM_ARIA_CBC",
            )
        finally:
    ...
    def test_aria_cbc_different_ivs(self, p11_raw_session: Any) -> None:
        ...
        try:
            ...
            if ct1 == ct2:
                classify(
                    "wrong_result",
                    kind="crypto",
                    label="CKM_ARIA_CBC:encrypt IV independence",
                    operation="C_Encrypt",
                    mechanism="CKM_ARIA_CBC",
    ...
    def test_aria_cbc_pad_roundtrip(self, p11_raw_session: Any) -> None:
        ...
        try:
            ...
            if ct == plaintext:
                classify(
                    "wrong_result",
                    kind="crypto",
                    label="CKM_ARIA_CBC_PAD:encrypt confidentiality",
                    operation="C_Encrypt",
            ...
            assert_correct(
                actual=pt,
                expected=plaintext,
                label="CKM_ARIA_CBC_PAD:decrypt roundtrip",
                operation="C_Decrypt",
                mechanism="CKM_ARIA_CBC_PAD",
            )
        finally:
    ...
    def test_aria_cbc_pad_different_keys(self, p11_raw_session: Any) -> None:
        ...
        try:
            ...
            if ct1 == ct2:
                classify(
                    "wrong_result",
                    kind="crypto",
                    label="CKM_ARIA_CBC_PAD:encrypt key independence",
                    operation="C_Encrypt",
                    mechanism="CKM_ARIA_CBC_PAD",
...
class TestARIAMAC:
    ...
    def test_aria_mac_sign_verify(self, p11_raw_session: Any) -> None:
    ...
    def test_aria_mac_general_sign_verify(self, p11_raw_session: Any) -> None:
    ...
    def test_aria_mac_different_keys(self, p11_raw_session: Any) -> None:
        ...
        try:
            ...
            if mac1 == mac2:
                classify(
                    "wrong_result",
                    kind="crypto",
                    label="CKM_ARIA_MAC:sign key independence",
                    operation="C_Sign",
...
class TestARIAKeyDerivation:
    ...
    def test_aria_ecb_encrypt_data_available(self, p11_raw_session: Any) -> None:
        ...
        if not rs.has_mechanism("ARIA_ECB_ENCRYPT_DATA"):
    ...
    def test_aria_cbc_encrypt_data_available(self, p11_raw_session: Any) -> None:
        """Check CKM_ARIA_CBC_ENCRYPT_DATA is advertised when ARIA is supported."""
        rs = p11_raw_session
        if not rs.has_mechanism("ARIA_KEY_GEN"):
            pytest.skip("CKM_ARIA_KEY_GEN not supported - skipping derivation check")
        if not rs.has_mechanism("ARIA_CBC_ENCRYPT_DATA"):
