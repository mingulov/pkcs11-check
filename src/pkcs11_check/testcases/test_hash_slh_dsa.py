...
# Hash-specific HASH_SLH_DSA variants (mechanism enum names).
...
_HASH_VARIANTS: list[str] = [
    ...
    "HASH_SLH_DSA_SHA384",
    "HASH_SLH_DSA_SHA512",
    "HASH_SLH_DSA_SHA3_224",
    "HASH_SLH_DSA_SHA3_256",
    "HASH_SLH_DSA_SHA3_384",
    "HASH_SLH_DSA_SHA3_512",
    "HASH_SLH_DSA_SHAKE128",
    "HASH_SLH_DSA_SHAKE256",
]
...
class TestHashSLHDSAGeneric:
    ...
    def test_mechanism_available(self, p11_module: Any) -> None:
        ...
        _skip_if_no(p11_module, "HASH_SLH_DSA")
...
class TestHashSLHDSAVariants:
    ...
    def test_sign_verify_roundtrip(self, p11_session: Any, p11_module: Any, mech_attr: str) -> None:
        ...
        _skip_if_no(p11_module, mech_attr)
        _skip_if_no(p11_module, "SLH_DSA")  # need keygen
