...
| phase1_last_run | **2026-04-30 DONE for 4/5 providers** — kryoptic / softhsm2 / nss-main / opencryptoki-master refreshed unfiltered. tpm2 first attempt FAILED (TPM-DBUS-001), fix landed (commit 2b932f3), retry running in background (`bl3xxk6sl`). |
| phase1_due | tpm2 retry in flight (background task `bl3xxk6sl`) |
