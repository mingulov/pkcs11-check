# Findings: `kryoptic-main`

Failures **106** · file-crashes **0** · classes **29** (sum 106). Root causes: [catalog.md](catalog.md); raw: [failure-inventory.json](failure-inventory.json).
...
- **[1]** `TestAESCBCEncryptData::test_derive_different_iv` — assert b'\xNaH\xaNL\xN.\xNf~\\<(\xcN\xdN\xaf\xbNG' != b'\xNaH\xaNL\xN.\xNf~\\<(\xcN\xdN\xaf\xbNG'
