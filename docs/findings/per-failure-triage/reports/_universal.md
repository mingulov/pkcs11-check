...
| **Op-termination lifecycle** | HIGH | 6 (kryoptic, nss, opencryptoki, softhsm2, tpm2, wolfpkcs11) | 164 | `sha1:0694006e303c2696#ph` test_operation_termination.py |
...
| **Wrong-output / crypto-correctness** | CRITICAL | 4 (kryoptic, nss, softhsm2, wolfpkcs11) | 15 | `sha1:bbe36dcd8a03c859#ph` test_aes_kdf.py |
