# Findings: `opencryptoki`

Failures **270** · file-crashes **0** · classes **50** (sum 270). Root causes: [catalog.md](catalog.md); raw: [failure-inventory.json](failure-inventory.json).
...
- **[1]** `TestRSAPaddingOracle::test_oaep_error_uniformity` — SECURITY: RSA-OAEP padding oracle — non-uniform error codes: {'CKR_FUNCTION_FAILED', 'CKR_ENCRYPTED_DATA_INVAL
