...
|----------|------|----------|---------|-------|
| **OpenSSL** | `openssl.sh` | C | 3.6.1 | Build dependency, not a PKCS#11 provider |
...
| **OpenCryptoki** | `opencryptoki.sh` | C | v3.26.0 | v3.0, needs pkcsslotd daemon |
...
bash local-builds/build.sh opencryptoki v3.26.0
```
