...
order = ["softhsm2", "softhsm2-generated-iv", "softhsm2-main", "kryoptic", "kryoptic-main", "kryoptic-fips", "nss", "nss-pqc", "nss-main", "nss-slot0", "nss-pqc-slot0", "nss-main-slot0", "opencryptoki", "opencryptoki-master", "wolfpkcs11", "wolfpkcs11-master", "corepkcs11", "corepkcs11-main", "tpm2", "pkcs11-mock", "bouncyhsm"]

targets.sort(key=lambda x: order.index(x["target"]) if x["target"] in order else 999)

print("| Docker target | Shards | Files | Total | Passed | Failed | Skipped | Xfailed | Errors | Crashed | Timeout | File-skipped units |")
print("| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |")
for t in targets:
    print(f"| `{t['target']}` | {t['shards']} | {t['files']} | {t['total']:,} | {t['passed']:,} | {t['failed']:,} | {t['skipped']:,} | {t['xfailed']:,} | {t['errors']:,} | {t['crashed']:,} | {t['timeout']:,} | {t['file_skipped']} |")
